...
def generate_enrollment_letter_html(first_name, last_name, school_id='2565'):
    ...
    Uses the new offer letter template for better SheerID pass rate.
    """
    from one.offer_letter import generate_offer_letter_html
    return generate_offer_letter_html(first_name, last_name, generate_psu_id, generate_psu_email)
